...
description: "Use for Fibe AI Genies, standalone chats, Playground sidecars, artefacts, mutters, feedback, job-mode Tricks, CI repair, scheduled jobs, VCS triggers, and mutation-testing automation."
...
3. User chats through the Agent chat page.
