...
A complete example combining job-mode + `metadata.trigger_config` + source-mounted watched service. Use as a starting point for any "run tests on every push" CI need.
